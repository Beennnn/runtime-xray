...
> Page de synthèse. Le détail outil par outil est dans [le comparatif](../etude/comparatif.md)
> et dans les [fiches individuelles](../etude/fiches). Le protocole est dans [la méthode](../etude/methode.md).
...
→ [Fiche JaCoCo](../etude/fiches/jacoco.md)
...
→ [Fiche async-profiler](../etude/fiches/async-profiler.md)
...
→ [Fiche Arthas](../etude/fiches/arthas.md)
...
3. **C'est le seul format standard capable de porter des valeurs de paramètres.** Un
   ...
   [JMC Agent](../etude/fiches/jmc-agent.md). Arthas, lui, produit du texte de console. Si le besoin
...
détaillé dans [les clés d'évaluation](../etude/cles-evaluation.md#ce-quon-attend-des-outils-commerciaux--et-pourquoi).

### Pour plus tard

- **[Kieker](../etude/fiches/kieker.md)** — le seul outil qui vise le *but final* : reconstruire une
...
rejets, avec leurs motifs, est dans [les outils écartés](../etude/outils-ecartes.md).
