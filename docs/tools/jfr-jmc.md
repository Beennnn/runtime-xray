...
détail et limites dans [RESULTS.md](../RESULTS.md#pourquoi-java-25-est-plus-précis--le-mécanisme).
...
installer.** Voir [les gains d'un portage](../RESULTS.md#gains-dun-portage-vers-java-25).
